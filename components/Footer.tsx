      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-between">
          <div className="w-full md:w-1/3 mb-6 md:mb-0">
            <h3 className="text-2xl font-semibold mb-4">The Cake Shop</h3>
            <p className="text-sm">Delicious cakes and pastries for every occasion</p>
          </div>
          <div className="w-full md:w-1/3 mb-6 md:mb-0">
          ...
          <div className="w-full md:w-1/3">
            ...
            <p className="mb-2">Email: info@sweetdelights.com</p>
            <p className="mb-4">Phone: (123) 456-7890</p>
            <div className="flex space-x-4">
              {['facebook', 'twitter', 'instagram'].map((social) => (
                <a key={social} href="#" className="text-white hover:text-[#FFF5E4] transition duration-300">
